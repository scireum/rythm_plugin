...
public class RythmClassAttrEndImpl extends ASTWrapperPsiElement implements RythmClassAttrEnd {

  public RythmClassAttrEndImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RythmVisitor visitor) {
    visitor.visitClassAttrEnd(this);
  }
