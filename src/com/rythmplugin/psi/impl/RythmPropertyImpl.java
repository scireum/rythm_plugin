...
public class RythmPropertyImpl extends ASTWrapperPsiElement implements RythmProperty {

  public RythmPropertyImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public RythmRythmMethod getRythmMethod() {
    return findChildByClass(RythmRythmMethod.class);
  }
