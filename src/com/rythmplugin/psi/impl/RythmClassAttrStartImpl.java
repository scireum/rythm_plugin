...
public class RythmClassAttrStartImpl extends ASTWrapperPsiElement implements RythmClassAttrStart {

    public RythmClassAttrStartImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitClassAttrStart(this);
    }
