...
public class RythmShiftLeftImpl extends ASTWrapperPsiElement implements RythmShiftLeft {

  public RythmShiftLeftImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RythmVisitor visitor) {
    visitor.visitShiftLeft(this);
  }
