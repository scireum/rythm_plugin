...
public class RythmMultiArgsImpl extends ASTWrapperPsiElement implements RythmMultiArgs {

    public RythmMultiArgsImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitMultiArgs(this);
    }
