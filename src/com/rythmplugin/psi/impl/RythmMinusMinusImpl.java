...
public class RythmMinusMinusImpl extends ASTWrapperPsiElement implements RythmMinusMinus {

    public RythmMinusMinusImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitMinusMinus(this);
    }
