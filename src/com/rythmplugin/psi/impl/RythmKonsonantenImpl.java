...
public class RythmKonsonantenImpl extends ASTWrapperPsiElement implements RythmKonsonanten {

  public RythmKonsonantenImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RythmVisitor visitor) {
    visitor.visitKonsonanten(this);
  }
