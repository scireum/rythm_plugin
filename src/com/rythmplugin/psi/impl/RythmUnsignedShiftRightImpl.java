...
public class RythmUnsignedShiftRightImpl extends ASTWrapperPsiElement implements RythmUnsignedShiftRight {

    public RythmUnsignedShiftRightImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitUnsignedShiftRight(this);
    }
