...
public class RythmGreaterOrEqImpl extends ASTWrapperPsiElement implements RythmGreaterOrEq {

  public RythmGreaterOrEqImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RythmVisitor visitor) {
    visitor.visitGreaterOrEq(this);
  }
