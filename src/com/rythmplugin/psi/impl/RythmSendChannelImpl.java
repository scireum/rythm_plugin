...
public class RythmSendChannelImpl extends ASTWrapperPsiElement implements RythmSendChannel {

    public RythmSendChannelImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitSendChannel(this);
    }
