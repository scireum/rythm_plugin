...
public class RythmRemainderEqImpl extends ASTWrapperPsiElement implements RythmRemainderEq {

    public RythmRemainderEqImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitRemainderEq(this);
    }
