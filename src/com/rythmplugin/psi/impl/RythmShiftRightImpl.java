...
public class RythmShiftRightImpl extends ASTWrapperPsiElement implements RythmShiftRight {

    public RythmShiftRightImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull RythmVisitor visitor) {
        visitor.visitShiftRight(this);
    }
