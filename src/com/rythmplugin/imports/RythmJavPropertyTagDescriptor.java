 ...
 */
public class RythmJavPropertyTagDescriptor implements  XmlElementDescriptor {
    private final PsiClass myPsiClass;
    private final String myName;
    private final boolean myStatic;

    public RythmJavPropertyTagDescriptor(PsiClass psiClass, String name, boolean isStatic) {
        myPsiClass = psiClass;
        myName = name;
        myStatic = isStatic;
    }
    ...
    public XmlElementDescriptor[] getElementsDescriptors(XmlTag context) {
        ...
        if (propertyType != null) {
            ...
            for (String name : RythmJavConstants.FX_BUILT_IN_TAGS) {
                descriptors.add(new RythmJavBuiltInTagDescriptor(name, null));
            }
            ...
            else if (!RythmJavPsiUtil.isPrimitiveOrBoxed(propertyType)) {
    ...
    private static void addElementDescriptor(@NotNull List<XmlElementDescriptor> descriptors, @Nullable PsiClass aClass) {
        if (aClass != null &&
                ...
                RythmJavPsiUtil.isAbleToInstantiate(aClass)) {
            descriptors.add(new RythmJavClassTagDescriptor(aClass.getName(), aClass));
        }
    }
    ...
    public PsiElement getDeclaration() {
        ...
        if (myStatic) return RythmJavPsiUtil.findStaticPropertySetter(myName, myPsiClass);
